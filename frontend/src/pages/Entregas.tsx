...
import { deliveriesApi, driversApi, routesApi, Delivery, DeliveryStatus, Driver, Route } from "@/services/api";
...
export default function Entregas() {
  ...
  const loadData = async () => {
    const [deliveriesData, driversData, routesData] = await Promise.all([deliveriesApi.getAll(), driversApi.getAll(), routesApi.getAll()]);
  ...
  const handleStatusUpdate = async (e: React.FormEvent) => {
    ...
    await deliveriesApi.updateStatus(selectedDelivery.id, statusFormData.status, statusFormData.notes);
    toast({
